    ...
    return (
        <div className='mx-96'>
            ...
            <div className='skills pt-10 '>
                <div className=''>
                    <h1 className='text-2xl text-center text-white mb-8'>Languages</h1>
              ...
              <div>
              <h1 className='text-2xl text-center text-white mb-8'>Frontend</h1>
              <div className='frontend pl-4'>
                ...
                <div>
                <h1 className='text-2xl text-center text-white mb-8'>Backend</h1>
               ...
               <div>
               <h1 className='text-2xl text-center text-white mb-8'>Others</h1>
